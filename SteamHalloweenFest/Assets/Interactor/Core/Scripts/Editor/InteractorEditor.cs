...
namespace razz
{
    ...
    public class InteractorEditor : Editor
    {
                ...
                if (animator = _script.GetComponentInChildren<Animator>())
                {
                    ...
                    if ((int)type == 0)
                    {
                        ...
                        if (effector)
                        {
                            ...
                            if (_script.effectorLinks[selectedEffectorTab].effectorName == "New Effector") _script.effectorLinks[selectedEffectorTab].effectorName = "Body";
                            RefreshTabNames();
                            EditorUtility.SetDirty(_script);
                        }
                        else
                        ...
                        AdjustInteractorIK(animator, InteractorIK.IKPart.Body);
                    }
                    else if ((int)type == 5)
                    {
                        ...
                        if (effector)
                        {
                            ...
                            if (lowerArm && hand)
                            {
                                ...
                                _script.transform.rotation = Quaternion.LookRotation(forwardDir, upDir);
                                if (_script.effectorLinks[selectedEffectorTab].effectorName == "New Effector") _script.effectorLinks[selectedEffectorTab].effectorName = "Left Hand";
                                RefreshTabNames();
                                EditorUtility.SetDirty(_script);
                            }
                            else
                        ...
                        AdjustInteractorIK(animator, InteractorIK.IKPart.LeftHand);
                    }
                    else if ((int)type == 6)
                    {
                        ...
                        if (effector)
                        {
                            ...
                            if (lowerArm && hand)
                            {
                                ...
                                _script.effectorLinks[selectedEffectorTab].minRadius = maxDist * 0.3f;
                                _script.transform.rotation = Quaternion.LookRotation(forwardDir, upDir);
                                if (_script.effectorLinks[selectedEffectorTab].effectorName == "New Effector") _script.effectorLinks[selectedEffectorTab].effectorName = "Right Hand";
                                RefreshTabNames();
                                EditorUtility.SetDirty(_script);
                            }
                            else
                        ...
                        AdjustInteractorIK(animator, InteractorIK.IKPart.RightHand);
                    }
                    else if ((int)type == 7)
                    {
                        ...
                        if (effector)
                        {
                            ...
                            if (lowerLeg && foot)
                            {
                                ...
                                _script.effectorLinks[selectedEffectorTab].minRadius = maxDist * 0.1f;
                                _script.transform.rotation = Quaternion.LookRotation(forwardDir, upDir);
                                if (_script.effectorLinks[selectedEffectorTab].effectorName == "New Effector") _script.effectorLinks[selectedEffectorTab].effectorName = "Left Foot";
                                RefreshTabNames();
                                EditorUtility.SetDirty(_script);
                            }
                            else
                        ...
                        AdjustInteractorIK(animator, InteractorIK.IKPart.LeftFoot);
                    }
                    else if ((int)type == 8)
                    {
                        ...
                        if (effector)
                        {
                            ...
                            if (lowerLeg && foot)
                            {
                                ...
                                _script.effectorLinks[selectedEffectorTab].minRadius = maxDist * 0.1f;
                                _script.transform.rotation = Quaternion.LookRotation(forwardDir, upDir);
                                if (_script.effectorLinks[selectedEffectorTab].effectorName == "New Effector") _script.effectorLinks[selectedEffectorTab].effectorName = "Right Foot";
                                RefreshTabNames();
                                EditorUtility.SetDirty(_script);
                            }
                            else
                        ...
                        AdjustInteractorIK(animator, InteractorIK.IKPart.RightFoot);
                    }
                    else
                    {
        ...
        private void CheckIKPass(Animator animator)
        {
            ...
            if (controller && controller.layers != null && controller.layers.Length > 0 && !controller.layers[0].iKPass)
            {
                Debug.LogWarning("The IK Pass option is not enabled in your Animator Controller's base layer. To resolve this, follow these steps: select your Animator, open the Animator Controller with a double click, click on the small gear icon next to the Base Layer (First Layer) in the left list. You will then see the IK Pass option, which you can enable.", animator);
            }
        }
        ...
        private void AdjustInteractorIK(Animator animator, InteractorIK.IKPart part)
        {
            if (!_script.interactorIK)
            {
                InteractorIK interactorIK = _script.GetComponent<InteractorIK>();
                _script.interactorIK = interactorIK;
                if (!interactorIK)
                {
                    interactorIK = _script.gameObject.AddComponent<InteractorIK>();
                    _script.interactorIK = interactorIK;
                    Debug.Log("InteractorIK component has been added to the Interactor gameObject.", _script.interactorIK);
                }
            }

            _script.interactorIK.Animator = animator;
            if (animator.gameObject != _script.interactorIK.gameObject)
            {
                if (!animator.gameObject.GetComponent<AnimatorCallback>())
                {
                    AnimatorCallback animCall = animator.gameObject.AddComponent<AnimatorCallback>();
                    animCall.interactorIk = _script.interactorIK;
                }
            }

            if (animator.isHuman) _script.interactorIK.isHumanoid = true;
            else return;

            if (_script.interactorIK.ikParts == null || _script.interactorIK.ikParts.Length == 0)
                _script.interactorIK.ikParts = new InteractorIK.IKParts[0];

            bool effectorExist = false;
            for (int i = 0; i < _script.interactorIK.ikParts.Length; i++)
            {
                if (_script.interactorIK.ikParts[i].part == part)
                {
                    effectorExist = true;
                    break;
                }
            ...
            if (!effectorExist)
            {
                List<InteractorIK.IKParts> uniqueIkParts = new List<InteractorIK.IKParts>();
                HashSet<InteractorIK.IKPart> uniquePartNames = new HashSet<InteractorIK.IKPart>();

                for (int i = 0; i < _script.interactorIK.ikParts.Length; i++)
                {
                    InteractorIK.IKParts existingPart = _script.interactorIK.ikParts[i];
                    if (uniquePartNames.Add(existingPart.part)) uniqueIkParts.Add(existingPart);
                    else continue;
                }

                InteractorIK.IKParts newIkPart = new InteractorIK.IKParts();
                newIkPart.part = part;
                newIkPart.matchChildBones = true;
                uniqueIkParts.Add(newIkPart);
                _script.interactorIK.ikParts = uniqueIkParts.ToArray();
                Debug.Log("New effector type has been added as a body part on InteractorIK.", _script.interactorIK);
            }
        }
        ...
        {
            string exampleScene1 = "01_ProtoMan";
            string exampleScene2 = "02_UnityArmature";
            string exampleScene3 = "03_InteractorPaths";
            string exampleScene4 = "04_InteractorAi";
            string exampleScene5 = "05_Pickables and Inventories";
