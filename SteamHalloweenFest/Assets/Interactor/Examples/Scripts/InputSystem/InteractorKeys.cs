...
public partial class @InteractorKeys: IInputActionCollection2, IDisposable
{
    ...
    ~@InteractorKeys()
    {
        UnityEngine.Debug.Assert(!m_InteractorExampleSceneControls.enabled, "This will cause a leak and performance issues, InteractorKeys.InteractorExampleSceneControls.Disable() has not been called.");
    }
