...
namespace razz
{
	...
	public class TagFilterPropertyDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
            ...
            /*EditorGUILayout.HelpBox("Type Specific Settings may change every InteractorObject that uses same settings file and may keep changes made in runtime.", MessageType.Warning);*/
