        ...
        private void ShowIntObjList()
        {
            ...
            while (i <= _interactor.intObjComponents.Count)
            {
                ...
                else
                {
                    ...
                    InteractionTypes type = _interactor.intObjComponents[i].interactorObject.interactionType;

                    if (type == InteractionTypes.DefaultAnimated || type == InteractionTypes.SelfItch || type == InteractionTypes.TouchHorizontalDown || type == InteractionTypes.TouchHorizontalUp || type == InteractionTypes.TouchStill || type == InteractionTypes.TouchVertical)
                    {
                        i++;
                        continue;
                    }
                    ...
                    if (_interactor.intObjComponents[i].interactorObject.ready && i == _interactor.selectedByUI)
                    {
                        ...
                        if (type == InteractionTypes.DistanceCrosshair)
                        {
